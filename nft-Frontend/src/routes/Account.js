...
import { useOwnedNft } from "../components/web3/hooks"
...
useEffect(()=>{
  ...
  if(ownedNft.data && ownedNft.data.length > 0){
    setActiveNft(ownedNft.data[0])
  }
           ...
           <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
             ...
             <section className="mt-8 pb-16" aria-labelledby="gallery-heading">
               ...
               >
                ...
                const nftMeta = nft.meta;
                if (typeof nftMeta === "string") {
                  const jsonObj = JSON.parse(nftMeta);
                  nft.meta = jsonObj;
                }
                  return(
                    <li
